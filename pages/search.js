  ...
  <div class="row align-items-center">
    <div class="col">
      <div class="species-search" id="species-list">
        ...
        <div class="form-inline">
          ...
          <button class="btn btn-outline-success my-2 my-sm-0 search" data-search="name"><img src="/img/search_white.svg" /></button>
        </div>
        <ul class="list"></ul>
      </div>
    </div>
    ...
    <div class="col">
      <div class="species-all">
        <button class="btn btn-link">Average Across All Species</button>
      </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="row">
            ...
            <div data-spy="scroll" data-target="#species-listing-alphabetical" data-offset="0">
              <!-- Todo: Add loop through sepcies -->
              <!-- onclick load charts and loop video -->
              <!-- <a href="species url"></a> -->
            </div>
          </div>
