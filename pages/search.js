  ...
  document.getElementById('search-wrap').innerHTML = `
    <div class="container">
      <div class="row align-items-end">
        ...
        <button id="species-list-alpha-toggle" class="col btn btn-link" type="button" data-toggle="collapse" data-target="#search-options" aria-expanded="false" aria-controls="search-options">Expand Options <img src="/img/chevron-down@2x.png" /></button>
      </div>
      <div class="row align-items-end">
